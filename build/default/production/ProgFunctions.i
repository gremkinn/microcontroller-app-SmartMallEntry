...
void exitF(void) {
    ...
    sendLCD(0b00000001, 0);
    sendLCD(0b10000011, 0);
    msgLCD("Thank you!");
    sendLCD(0b11000001, 0);
    msgLCD("~See you soon~");
...
void empty(void) {
    ...
    while (1) {
        ...
        if (PORTBbits.RB1 == 0) {
            ...
            sendLCD(0b00000001, 0);
            break;
        } else if (PORTBbits.RB4 == 0 || PORTBbits.RB2 != capLimitStatus)
            break;
    }
}
